...
<div style="width: 100%; overflow: hidden;">
  <iframe id="myIframe" src="/web/album/index.html" width="100%" height="100%" style="border:none; overflow-x: auto;" scrolling="no"></iframe>
</div>
...
<script>
  ...
  iframe.onload = function() {
    ...
    // iframe 내에서 body에 스타일을 적용하여 스크롤 처리
    contentDocument.body.style.overflowX = 'auto';   // 좌우 스크롤 보이기
    contentDocument.body.style.overflowY = 'hidden';  // 상하 스크롤 숨기기
